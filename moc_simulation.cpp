...
QT_MOC_LITERAL(1, 11, 13), // "astresUpdated"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "Simulation\0astresUpdated\0"
};
...
void Simulation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Simulation::astresUpdated)) {
                *result = 0;
                return;
            }
        }
